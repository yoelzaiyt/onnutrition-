...
const foodImages = [
  ...
  },
  {
    ...
    title: "Buddha Bowl",
    category: "Almoço Nutritivo",
    icon: Leaf,
  },
  {
    id: 5,
    src: "https://images.unsplash.com/photo-1553530979-7ee52a2670c4?auto=format&fit=crop&q=80&w=800",
  ...
  {
    id: 6,
    src: "https://images.unsplash.com/photo-1604937455095-ef3fe8c9e10d?auto=format&fit=crop&q=80&w=800",
    title: "Avo toast",
    category: "Café Saudável",
    icon: Apple,
  },
  {
    id: 7,
    ...
    category: "Refeição Leve",
    icon: Carrot,
  },
  {
    id: 8,
    src: "https://images.unsplash.com/photo-1610970881699-44a5587cabec?auto=format&fit=crop&q=80&w=800",
    title: "Smoothie Frutas",
    category: "Café da Manhã",
    icon: Droplets,
  },
  {
    id: 9,
    src: "https://images.unsplash.com/photo-1482049016gy-84b44a585fe1?auto=format&fit=crop&q=80&w=800",
  ...
  {
    id: 10,
    src: "https://images.unsplash.com/photo-1623428187969-5da2dcea5ebf?auto=format&fit=crop&q=80&w=800",
    title: "Suco Verde",
    category: "Detox",
    icon: Leaf,
  },
  {
    id: 11,
    src: "https://images.unsplash.com/photo-1592417817098-8fd3d9eb14a5?auto=format&fit=crop&q=80&w=800",
  ...
  {
    id: 12,
    src: "https://images.unsplash.com/photo-1550304943-4f24f54ddde9?auto=format&fit=crop&q=80&w=800",
    title: "Açaí Bowl",
...
const LandingPage: React.FC<LandingPageProps> = ({
  ...
  const testimonials = [
    {
      quote:
        "O ONNutrition revolucionou minha prática. A IA que analisa as fotos dos pacientes me poupa horas de trabalho por semana.",
    ...
    {
      quote:
        "Migrei do Dietbox e não me arrependo. A estabilidade é muito superior e as teleconsultas integradas são um diferencial.",
    ...
    <div className="min-h-screen bg-[#F8FAFC] font-sans text-slate-900 overflow-x-hidden">
      ...
      <nav className="max-w-7xl mx-auto px-6 py-8 flex items-center justify-between relative z-50">
        ...
        <div className="hidden lg:flex items-center gap-10 text-slate-400 font-black text-[10px] uppercase tracking-[0.2em]">
          <a href="#" className="hover:text-[#22B391] transition-all">
            Recursos
          </a>
          <a href="#" className="hover:text-[#22B391] transition-all">
            Metodologia
          ...
          <div className="grid lg:grid-cols-2 gap-20 items-center">
            ...
            >
              ...
              <h1 className="text-[12vw] lg:text-[7rem] font-serif italic leading-[0.85] text-[#0B2B24] mb-10 tracking-[-0.04em]">
                O futuro da <br />
                <span className="text-[#22B391] not-italic font-sans font-black uppercase tracking-tighter">
                  Nutrição
                </span>
              </h1>

              <p className="text-xl text-slate-500 max-w-lg mb-12 font-medium leading-relaxed">
                A plataforma definitiva para nutricionistas que buscam
                excelência, automação e resultados reais para seus pacientes.
              </p>
                  ...
                  <div className="bg-white/10 backdrop-blur-xl border border-white/20 p-8 rounded-[2.5rem] text-white">
                    <div className="flex gap-1 mb-4">
                      {[...Array(5)].map((_, i) => (
                        <Star
                          key={i}
                          className="w-4 h-4 fill-[#22B391] text-[#22B391]"
                        />
                      ))}
                    </div>
                    <p className="text-lg font-medium italic mb-6 leading-relaxed">
                      &quot;A melhor ferramenta que já usei para acompanhar meus
                      pacientes em tempo real.&quot;
                    </p>
                    <div className="flex items-center gap-4">
                      <div className="w-10 h-10 bg-[#22B391] rounded-full flex items-center justify-center font-black text-xs">
                        CS
                      </div>
                      <div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-12 text-center">
            {[
              ...
              <div key={i}>
                <p className="text-4xl lg:text-5xl font-black text-[#0B2B24] mb-2 tracking-tighter">
                  {stat.value}
                </p>
      ...
      <section className="py-32 px-6 bg-[#F8FAFC]">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-24">
            <h2 className="text-5xl lg:text-6xl font-black text-[#0B2B24] mb-6 tracking-tight">
              Tudo o que você precisa.
            </h2>
            <p className="text-xl text-slate-500 max-w-2xl mx-auto font-medium">
              Uma plataforma integrada que cuida de toda a jornada do seu
              paciente.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              >
                <div
                  className={`w-14 h-14 ${feature.color} text-white rounded-2xl flex items-center justify-center mb-8 group-hover:scale-110 transition-transform`}
                >
                  <feature.icon className="w-6 h-6" />
                </div>
                <h3 className="text-2xl font-black text-[#0B2B24] mb-4 tracking-tight">
                  {feature.title}
                </h3>
      ...
      <footer className="bg-[#0B2B24] py-20 px-6 text-white text-center">
        <div className="max-w-7xl mx-auto">
          ...
          <p className="text-white/40 text-sm font-bold tracking-widest uppercase mb-8">
            © 2026 ONNutrition. Todos os direitos reservados.
          </p>
