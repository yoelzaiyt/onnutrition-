...
export const LoginPage: React.FC<AuthProps> = ({ onLogin, onGoToRegister, onBackToLanding }) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (isNetworkError) {
        setError('Erro de conexão: Verifique se as chaves do Supabase estão configuradas corretamente no painel de Segredos (⚙️).');
      } else {
...
export const RegisterPage: React.FC<AuthProps> = ({ onLogin, onGoToLogin, onBackToLanding }) => {
  ...
  const handleRegister = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (authData.user) {
        const finalRole = email === 'word.intelligence@gmail.com' ? 'nutri' : selectedType;
